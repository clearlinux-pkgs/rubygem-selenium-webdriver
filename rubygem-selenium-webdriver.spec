...
%files lib
%defattr(-,root,root,-)
%exclude /usr/lib64/ruby/gems/2.3.0/gems/selenium-webdriver-2.53.4/lib/selenium/webdriver/firefox/native/linux/amd64/x_ignore_nofocus.so
%exclude /usr/lib64/ruby/gems/2.3.0/gems/selenium-webdriver-2.53.4/lib/selenium/webdriver/firefox/native/linux/x86/x_ignore_nofocus.so
